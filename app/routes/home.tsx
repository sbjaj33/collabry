      ...
      <section className="hero">
          <div className="announce">
            <div className="dot">
              ...
              <p>Introducing Collabry 2.0</p>
          </div>

          <h1>Build beautiful spaces at the speed of thought
              with Collabry</h1>
          <p className="subtitle">
              Collabry is an AI-first design environment that helps you
              visualise, render and ship architectural projects faster than ever.
          </p>
          ...
          <section className="projects">
              <div className="section-inner">
                  <div className="section-head">
                    <div className="copy">
                        <h2>Projects</h2>
                        <p>Your latest works and shared
                        community projects, all at one place</p>
                    </div>
                  </div>
